...
```{r, echo=FALSE}
setwd("C:/Users/Byoungwook Jang/Google Drive/teaching/stats406_f17_labs/lab3/data")
```
...
```{r,echo=FALSE}
setwd("C:/Users/Byoungwook Jang/Google Drive/teaching/stats406_f17_labs/lab3")
```
